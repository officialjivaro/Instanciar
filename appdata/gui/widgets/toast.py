...
_TOAST_THEMES = {
    ...
    "success": {"accent": SUCCESS_COLOR, "label": "Success", "duration": 3200},
    "error": {"accent": DANGER_COLOR, "label": "Error", "duration": 5200},
    "warning": {"accent": WARNING_COLOR, "label": "Warning", "duration": 4200},
}
